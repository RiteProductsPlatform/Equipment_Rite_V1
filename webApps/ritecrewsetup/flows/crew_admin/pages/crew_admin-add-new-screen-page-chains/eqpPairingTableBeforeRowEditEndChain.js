define([
  ...
  class eqpPairingTableBeforeRowEditEndChain extends ActionChain {
    ...
    async run(context, { event, accept, setUpdatedItem, rowContext, cancelEdit, rowKey, rowIndex, rowData }) {
      ...
      await Actions.resetVariables(context, {
        variables: [
    '$variables.selectedEqpPairKey',
  ],
      });
    }
  }

  return eqpPairingTableBeforeRowEditEndChain;
});
