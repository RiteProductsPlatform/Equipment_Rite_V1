define([
  ...
  class saveQuoteAmount extends ActionChain {
    ...
    async run(context) {
      ...
      const reservationData = {
        ...
        equipment_number: $variables.selectedEquipmentNumber,
         equipment_name: $variables.selectedEquipment.equipmentName,
        equipment_id: $variables.selectedEquipment.equipment_id,
      ...
      let index = $variables.updateQuote.findIndex(item =>
        ...
        item.equipment_id ===$variables.selectedEquipment.equipment_id
      );
