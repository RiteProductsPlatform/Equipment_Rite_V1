define([
  ...
  class PageVbEnterChain extends ActionChain {
    ...
    async run(context, { event }) {
      ...
      const calculateTotalQuoteAmount = await $page.functions.calculateTotalQuoteAmount(response.body.items);

      $variables.totalquoteAmount = calculateTotalQuoteAmount;
