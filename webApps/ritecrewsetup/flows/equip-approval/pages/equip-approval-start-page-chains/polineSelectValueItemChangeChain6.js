define([
  ...
  class polineSelectValueItemChangeChain6 extends ActionChain {
    ...
    async run(context, { event, previousValue, value, updatedFrom, key, data, metadata, valueItem }) {
      ...
      if (data) {
        ...
        $variables.poVariables.receipt = data.receipt_number;
         $variables.poVariables.org = data.delivery_organization;
  ...
  return polineSelectValueItemChangeChain6;
});
